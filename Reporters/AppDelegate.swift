...
//        print("modifyNotificationTokens")
//        if CONSTANTS.INFO.APP.DATA.USER.IS_LOGIN() {
//            if let userID: String = CONSTANTS.INFO.APP.DATA.USER.DATA.GET(key: CONSTANTS.KEYS.JSON.FIELD.USER_ID) as? String  {
...
//                    if let oldOneSignalID: String = CONSTANTS.INFO.APP.DATA.USER.DATA.GET(key: CONSTANTS.KEYS.JSON.FIELD.NOTIFICATIONS.ONESIGNAL) as? String, let oldDeviceToken: String = CONSTANTS.INFO.APP.DATA.USER.DATA.GET(key: CONSTANTS.KEYS.JSON.FIELD.NOTIFICATIONS.TOKEN) as? String {
//                        if oldOneSignalID == oneSignalID && oldDeviceToken == deviceToken {
//                            return
//                        }
//                    }
...
//                        CONSTANTS.INFO.APP.DATA.USER.DATA.UPDATE(data: argument)
//                    }
//                }
//            }
//        }
